...
def activfunc():
    ...
    #Homepage of the appilication
    with st.container():
            st.subheader("Environmental")
            st.caption("Environmental, involves how organizations perform as a steward of our natural environment, with a focus on: waste, pollution, resource depletion, greenhouse gas emissions, deforestation, and climate change.")
    with st.container():
            st.subheader("Social")
            st.caption("How companies treat people, with a concentration on: employee relations, diversity, working conditions, serving underdeveloped communities, health/safety, and conflict.")
    with st.container():
